...
// About — held at the kept What We Do grid while the rest of the page gets
// planned properly with George. Nothing else lives here on purpose.
      ...
      <main ref={root} className="relative z-10 overflow-x-clip bg-[var(--bg)] text-[var(--fg)]">
        <section data-surface="page" className="relative z-10 bg-[var(--bg)] pb-[14vh] pt-[22vh]">
          <div className="text-center">
            ...
            <span aria-hidden data-enter-line className="mx-auto mt-7 block h-px w-[min(52vw,640px)] bg-[var(--fg)]/60" />
          </div>
